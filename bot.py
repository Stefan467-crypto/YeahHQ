...
COMMANDS_SECTIONS = {
    "cmd_section_mod": {
        ...
        "commands": [
            ...
            ("⚠️ Варн (платно)",         "/warn @user [причина]",    True,  "!варн"),
    ...
    "cmd_section_roles": {
        "title": "🎖 Должности",
        "commands": [
            ("⬆️ Повысить",              "/promote @user [0-5]",     False, "!повысить"),
            ("⬇️ Понизить на 1",         "/demote @user",            False, "!понизить"),
            ("🔻 Разжаловать",           "/firekick @user",          False, "!разжаловать"),
            ("👥 Состав сервера",        "/staff",                   False, "!админы"),
            ("🆔 Моя должность",         "/whoami",                  False, "!кто я"),
            ("🏷 Ник",                   "/nick [текст|@user]",      False, "!ник"),
            ("📋 Все ники чата",         "/nicks",                   False, "!ники"),
            ("🗑 Удалить ник",           "/removenick [@user]",      False, None),
            ("🔍 Скан участников",       "/scan",                    False, None),
        ]
    },
    "cmd_section_fun": {
        "title": "🎮 Развлечения",
        "commands": [
            ...
            ("🎱 Магический шар",        "/8ball [вопрос]",          False, "!шар"),
            ("🪙 Монетка",               "/coinflip",                False, "!монетка"),
            ("🎲 Кубик",                 "/roll [стороны]",          False, "!кубик"),
            ("🤔 Выбор",                 "/choose А|Б|В",            False, "!выбери"),
            ("💘 Совместимость",         "/ship @user",              False, "!совместимость"),
            ("🎯 Спор",                  "/bet @user",               False, "!спор"),
            ("🎉 Похвалить",             "/gg @user",                False, "!хвалю"),
            ("😈 Подколоть (мод+)",      "/ff @user",                False, None),
        ]
    },
    "cmd_section_rep": {
        "title": "⭐ Репутация & AFK",
        "commands": [
            ("⬆️ Репутация +/-",         "/rep @user +/-",           False, None),
            ("🏅 Топ репутации",          "/toprep",                  False, None),
            ("⭐ Моя репутация",          "/myrep",                   False, "!репа"),
            ("💤 AFK статус",            "/afk [причина]",           False, "!afk"),
            ("👁 Последняя активность",  "/lastseen @user",          False, None),
        ]
    },
    "cmd_section_settings": {
        "title": "⚙️ Настройки чата",
        "commands": [
    ...
    "cmd_section_profile": {
        ...
        "commands": [
            ...
            ("📊 Полная статистика",     "/mystats [@user]",         False, "!статистика"),
...
def main():
    ...
    app.add_handler(CommandHandler("8ball", ball_cmd))
    app.add_handler(CommandHandler("gg", gg_cmd))
    ...
    app.add_handler(CommandHandler(["mystats", "stats"], mystats_cmd))
